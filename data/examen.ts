// Cédula tipo examen de grado. Contenido trasladado sin cambios desde app/examen/page.tsx.

export type Pregunta = { q: string; opciones: string[]; correcta: number; explicacion: string; art: string };
